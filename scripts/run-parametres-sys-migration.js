...
async function runMigration() {
  try {
    console.log('🚀 Migration table paramètres système (tbl_parametres_sys)...\n');
    ...
    const [t] = await sequelize.query(`
      ...
      WHERE table_schema = DATABASE() AND table_name = 'tbl_parametres_sys'
    `);
    if (t[0].c > 0) console.log('✅ tbl_parametres_sys créée avec succès.');
