...
function formatConnaissementForClient(row) {
  ...
  return {
    ...
    idSupportClient: j.idSupportClient ?? j.id_support_client ?? null,
    id_support_client: j.idSupportClient ?? j.id_support_client ?? null,
    nomSupportClient: j.nomSupportClient ?? j.nom_support_client ?? null,
    nom_support_client: j.nomSupportClient ?? j.nom_support_client ?? null,
    status,
