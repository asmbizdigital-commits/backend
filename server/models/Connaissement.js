...
const Connaissement = sequelize.define(
  'Connaissement',
  {
    ...
    paysOrigine: { type: DataTypes.STRING(255), allowNull: true, field: 'pays_origine' },
    goodsDescription: { type: DataTypes.TEXT, field: 'goods_description' },
    totalPackages: { type: DataTypes.STRING(50), field: 'total_packages' },
    typeColis: { type: DataTypes.STRING(255), allowNull: true, field: 'type_colis' },
    ...
    /** Call center / support client (distinct de controle_par_* et des assignations contrôle). */
