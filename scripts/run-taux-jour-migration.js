...
async function runMigration() {
  try {
    console.log('🚀 Migration table taux journaliers (tbl_taux_jour)...\n');
    ...
    const [t] = await sequelize.query(`
      ...
      WHERE table_schema = DATABASE() AND table_name = 'tbl_taux_jour'
    `);
    if (t[0].c > 0) console.log('✅ tbl_taux_jour créée avec succès.');
