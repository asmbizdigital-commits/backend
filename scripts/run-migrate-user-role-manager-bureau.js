/**
 * Ajoute la valeur ENUM Manager Bureau sur tbl_utilisateurs.role.
...
async function main() {
  ...
  console.log(`Migration rôle ${NEW_ROLE} (ENUM tbl_utilisateurs.role)`);
  ...
  try {
    ...
    console.log(`✅ Colonne role mise à jour (${NEW_ROLE} ajouté).`);
  } catch (e) {
