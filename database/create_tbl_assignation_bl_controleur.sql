...
CREATE TABLE IF NOT EXISTS `tbl_assignation_bl_controleur` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_assign_bl_ctrl_bl_document_id` (`bl_document_id`),
  ...
  CONSTRAINT `fk_assign_bl_ctrl_document` FOREIGN KEY (`bl_document_id`) REFERENCES `bl_documents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
